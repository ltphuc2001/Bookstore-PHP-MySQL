...
$id                = $this->bookInfo['id'];
$saleOff           = $this->bookInfo['sale_off'];
$price             = $this->bookInfo['price'];
$name              = $this->bookInfo['name'];
$category_id       = $this->bookInfo['category_id'];
$category_name     = $this->bookInfo['category_name'];
...
//$linkOrder         = URL::createLink('default', 'user', 'order', ['book_id' => $id, 'price' => $price]);

$addCartItem              = 'javascript:addCartItem(\'' . $this->bookInfo['id'] . '\', \'' . number_format((100 - $saleOff) * $price / 100) . '\', quantity)';

$description       = $this->bookInfo['description'];
$picture           = IMG_DEFAULT_BOOK_PATH .  $this->bookInfo['picture'];
$linkChangeQty     =  URL::createLink($this->arrParams['module'], 'user',  'ajaxUpdateCart', ['quantity' => 'value_new', 'id' => $this->bookInfo['id']]);

if ($this->bookInfo['sale_off'] > 0) {
    $classPrice = '
                    <h4><del>' . number_format($price) . ' đ</del><span> -' . $saleOff . '%</span></h4>
                    <h3>' . number_format((100 - $saleOff) * $price / 100) . ' đ</h3>
    ';
    $linkOrder  = URL::createLink('default', 'user', 'order', ['book_id' => $id, 'price' => number_format((100 - $saleOff) * $price / 100)]);
} else {
    $classPrice = '                   
                    <h3>' . number_format($price) . ' đ</h3>
    ';
    $linkOrder  = URL::createLink('default', 'user', 'order', ['book_id' => $id, 'price' => number_format((100 - $saleOff) * $price / 100)]);
}
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    <div class="product-slick slick-initialized slick-slider"><div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 310px;"><div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 310px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;"><div>

                                    <div style="width: 100%; display: inline-block;">
                                        <img src="' . $picture . '" alt="" class="img-fluid w-100 image_zoom_cls-0"></div></div></div></div></div></div>
                                </div>
                                <div class="col-lg-8 col-xl-8 rtl-text">
                                    <div class="product-right">
                                            ...
                                            <div class="qty-box">
                                                <div class="input-group">
                                                    <span class="input-group-prepend">
                                                        <button type="button" class="btn-qty btn quantity-left-minus" data-type="minus"      data-field=""><i class="ti-angle-left"></i>
                                                        </button> 
                                                    </span>

                                                    <input type="text" name="quantity" class="form-control input-number" value="1" id="quantity-item">

                                                    <span class="input-group-prepend">
                                                        <button type="button" class="btn-qty btn quantity-right-plus" data-type="plus" data-field="">
                                        ...
                                        <div class="product-buttons">
                                            <a href="' . $addCartItem . '" class="btn btn-solid ml-0 btn-add-item-cart"><i class="fa fa-cart-plus"></i> Chọn mua</a>
                                        </div>
...
$xhtmlBookNews = '';
$classPrice = '';
if (count($this->bookNews)) {
    foreach ($this->bookNews as $key => $item) {
        $id                = $item['id'];
        ...
        <div class="media">
            <a href="' . $link . '">
                <img class="img-fluid blur-up lazyloaded" src="' . $picture . '" alt="' . $name . '"></a>
...
<?php require_once 'elements/breadcrumbItem.php' ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="theme-card mt-4">
                        ...
                        <div class="offer-slider slide-1 slick-initialized slick-slider">
            ...
            <div class="row">
                <section class="section-b-space j-box ratio_asos pb-0">
                    <div class="container">
                        ...
                        <?php require_once 'elements/bookRelate.php' ?>
                    </div>
                </section>
